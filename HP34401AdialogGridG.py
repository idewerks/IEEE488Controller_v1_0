...
# Form implementation generated from reading ui file 'HP34401AdialogGridG.ui'
#
...
class Ui_HP34401ADialog(object):
    def setupUi(self, HP34401ADialog):
        ...
        sizePolicy.setHeightForWidth(HP34401ADialog.sizePolicy().hasHeightForWidth())
...
"color: rgb(0, 255, 255);")
        ...
        self.samplesSlider.setStyleSheet("background-color: rgb(7, 142, 198);\n"
"background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(0, 0, 0, 255), stop:1 rgba(255, 255, 255, 255));")
        ...
        self.samplestakenLabel_2.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
...
"color: rgb(0, 255, 255);")
        ...
        self.gridLayout_3.addWidget(self.frame_5, 0, 1, 1, 1, QtCore.Qt.AlignBottom)
        ...
        self.gridLayout_3.addWidget(self.label_3, 2, 1, 1, 1, QtCore.Qt.AlignBottom)
        self.label = QtWidgets.QLabel(HP34401ADialog)
        self.label.setObjectName("label")
        self.gridLayout_3.addWidget(self.label, 1, 1, 1, 1, QtCore.Qt.AlignBottom)
    ...
    def retranslateUi(self, HP34401ADialog):
        ...
        self.PlotsettingsLabel.setText(_translate("HP34401ADialog", "PLOT SETTINGS"))
        ...
        self.showminmaxcheckBox.setText(_translate("HP34401ADialog", "SHOW MIN/MAX"))
        self.plotaveragecheckBox.setText(_translate("HP34401ADialog", "PLOT AVERAGE"))
        self.showdatapointscheckBox.setText(_translate("HP34401ADialog", "SHOW DATAPOINTS"))
        self.savescanpushButton.setText(_translate("HP34401ADialog", "SAVE CSV"))
